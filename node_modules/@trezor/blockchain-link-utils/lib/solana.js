...
const transformTokenInfo = (tokenAccounts, tokenDetailByMint) => {
    const tokens = ts_belt_1.F.toMutable((0, ts_belt_1.pipe)(tokenAccounts, ts_belt_1.A.filter(isSplTokenAccount), ts_belt_1.A.map(tokenAccount => {
        ...
        if (acc[token.contract] != null) {
            acc[token.contract].balance = new bignumber_js_1.default(acc[token.contract].balance || '0')
...
const extractAccountBalanceDiff = (transaction, address, isTokenDiff = false) => {
    ...
    if (isTokenDiff) {
        ...
        return {
            preBalance: new bignumber_js_1.default(preBalance !== null && preBalance !== void 0 ? preBalance : 0),
            postBalance: new bignumber_js_1.default(postBalance !== null && postBalance !== void 0 ? postBalance : 0),
        };
    }
...
const getNativeTransferTxType = (effects, accountAddress, transaction) => {
    ...
    if (effects.length === 1 &&
        ...
        ((_b = effects[0]) === null || _b === void 0 ? void 0 : _b.amount.abs().isEqualTo(new bignumber_js_1.default(((_c = transaction.meta) === null || _c === void 0 ? void 0 : _c.fee) || 0)))) {
        return 'self';
    }
...
const getDetails = (transaction, effects, accountAddress, txType) => {
    ...
    return {
        ...
        totalInput: senders
            .reduce((acc, curr) => acc.plus(curr.amount.abs()), new bignumber_js_1.default(0))
            .toString(),
...
const getAmount = (accountEffect, txType) => {
    ...
    if (txType === 'self') {
        return (_a = accountEffect.amount) === null || _a === void 0 ? void 0 : _a.abs().toString();
    }
