...
var AbstractMessageChannel = (function (_super) {
    ...
    AbstractMessageChannel.prototype.resolveMessagePromises = function (resolvePayload) {
        var _this = this;
        Object.keys(this.messagePromises).forEach(function (id) {
            return _this.messagePromises[id].resolve({
                id: id,
                payload: resolvePayload,
            });
        });
    };
    AbstractMessageChannel.prototype.clear = function () {
