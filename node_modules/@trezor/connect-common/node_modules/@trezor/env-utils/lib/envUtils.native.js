...
const react_native_config_1 = tslib_1.__importDefault(require("react-native-config"));
...
const getSuiteVersion = () => react_native_config_1.default.VERSION || '';
const getCommitHash = () => react_native_config_1.default.COMMIT_HASH || '';
...
const isLinux = () => false;
const isCodesignBuild = () => react_native_config_1.default.CODESIGN_BUILD === 'true';
