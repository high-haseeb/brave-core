...
var _filecoinNumber = require("@glif/filecoin-number");
...
var Filecoin = function Filecoin(provider) {
  ...
  (0, _classCallCheck2["default"])(this, Filecoin);
  (0, _defineProperty2["default"])(this, "wallet", void 0);
  (0, _defineProperty2["default"])(this, "jsonRpcEngine", void 0);
  (0, _defineProperty2["default"])(this, "getBalance", /*#__PURE__*/function () {
      ...
      return _regenerator["default"].wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              (0, _filecoinAddress.checkAddressString)(address);
              _context.next = 3;
              return _this.jsonRpcEngine.request('WalletBalance', address);

            case 3:
              balance = _context.sent;
              return _context.abrupt("return", new _filecoinNumber.FilecoinNumber(balance, 'attofil'));
  ...
  (0, _defineProperty2["default"])(this, "simulateMessage", /*#__PURE__*/function () {
      ...
      return _regenerator["default"].wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              res = _context2.sent;
              return _context2.abrupt("return", (0, _utils.allCallsExitWithCode0)(res));
  ...
  (0, _defineProperty2["default"])(this, "sendMessage", /*#__PURE__*/function () {
    var _ref3 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(signedLotusMessage) {
      return _regenerator["default"].wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              if (signedLotusMessage.Message) {
                _context3.next = 2;
                break;
              }
            ...
            case 2:
              if (signedLotusMessage.Signature) {
                _context3.next = 4;
                break;
              }
            ...
            case 4:
              return _context3.abrupt("return", _this.jsonRpcEngine.request('MpoolPush', signedLotusMessage));
  ...
  (0, _defineProperty2["default"])(this, "getNonce", /*#__PURE__*/function () {
    var _ref4 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(address) {
      var nonce;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 12:
              ...
              if (!(_context4.t2 !== null && _context4.t2 !== void 0 && _context4.t2.message.toLowerCase().includes('actor not found'))) {
                _context4.next = 17;
                break;
              }
            ...
            case 17:
              throw new Error(_context4.t2.message);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 6:
              ...
              if (_context5.t0 instanceof Error && _context5.t0.message.toLowerCase().includes('actor not found')) {
                coinType = clonedMsg.From[0];
                if (!clonedMsg.From) clonedMsg.From = _utils.KNOWN_TYPE_0_ADDRESS[coinType];
                if (clonedMsg.From[1] === '0') clonedMsg.From = _utils.KNOWN_TYPE_0_ADDRESS[coinType];else if (clonedMsg.From[1] === '1') clonedMsg.From = _utils.KNOWN_TYPE_1_ADDRESS[coinType];else if (clonedMsg.From[1] === '3') clonedMsg.From = _utils.KNOWN_TYPE_3_ADDRESS[coinType];else {
                  // this should never happen, only t1 and t3 addresses can be used as a from?
                  clonedMsg.From = _utils.KNOWN_TYPE_0_ADDRESS[coinType];
                }
              }
  ...
  (0, _defineProperty2["default"])(this, "gasEstimateFeeCap", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 7:
              ...
              return _context6.abrupt("return", new _filecoinNumber.FilecoinNumber(feeCap, 'attofil'));
  ...
  (0, _defineProperty2["default"])(this, "gasEstimateGasLimit", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 7:
              ...
              return _context7.abrupt("return", new _filecoinNumber.FilecoinNumber(gasLimit, 'attofil'));
  ...
  (0, _defineProperty2["default"])(this, "gasEstimateGasPremium", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 8:
              ...
              return _context8.abrupt("return", new _filecoinNumber.FilecoinNumber(gasPremium, 'attofil'));
  ...
  (0, _defineProperty2["default"])(this, "gasEstimateMessageGas", /*#__PURE__*/function () {
      ...
      return _regenerator["default"].wrap(function _callee9$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              maxFee = _args9.length > 1 && _args9[1] !== undefined ? _args9[1] : new _filecoinNumber.FilecoinNumber('0.1', 'fil').toAttoFil();
            ...
            case 8:
              ...
              return _context9.abrupt("return", new _filecoinMessage.Message({
  ...
  (0, _defineProperty2["default"])(this, "gasEstimateMaxFee", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            ...
            case 2:
              ...
              feeCap = new _bignumber.BigNumber(msgWithGas.GasFeeCap);
              limit = new _bignumber.BigNumber(msgWithGas.GasLimit);
              return _context10.abrupt("return", {
                maxFee: new _filecoinNumber.FilecoinNumber(feeCap.times(limit), 'attofil'),
                message: msgWithGas
              });
  ...
  (0, _defineProperty2["default"])(this, "gasCalcTxFee", /*#__PURE__*/function () {
    var _ref11 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee11(gasFeeCap, gasPremium, gasLimit, baseFee, gasUsed) {
      ...
      return _regenerator["default"].wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              gasFeeCapBN = new _bignumber.BigNumber(gasFeeCap);
              gasPremiumBN = new _bignumber.BigNumber(gasPremium);
              gasLimitBN = new _bignumber.BigNumber(gasLimit);
              baseFeeBN = new _bignumber.BigNumber(baseFee);
              gasUsedBN = new _bignumber.BigNumber(gasUsed);
              /* compute left side */

              gasToBurn = (0, _utils.computeGasToBurn)(gasUsedBN, gasLimitBN);
              totalGas = gasUsedBN.plus(gasToBurn);
              minBaseFeeFeeCap = _bignumber.BigNumber.minimum(baseFeeBN, gasFeeCapBN);
              leftSide = totalGas.times(minBaseFeeFeeCap);
              /* compute right side */

              minTip = _bignumber.BigNumber.minimum(gasFeeCapBN.minus(baseFeeBN), gasPremiumBN);
              rightSide = gasLimitBN.times(_bignumber.BigNumber.maximum(0, minTip));
              return _context11.abrupt("return", new _filecoinNumber.FilecoinNumber(leftSide.plus(rightSide), 'attofil'));
        ...
        while (1) {
          switch (_context12.prev = _context12.next) {
            ...
            case 3:
              ...
              copiedMessage = _objectSpread(_objectSpread({}, message), {}, {
                GasFeeCap: '0',
                GasPremium: '0',
                GasLimit: 0
              });
            ...
            case 10:
              recommendedMessage = _context12.sent;
              takeMin = recommendedMessage.gasFeeCap.isLessThan(minGasFeeCap) || recommendedMessage.gasPremium.isLessThan(minGasPremium) || recommendedMessage.gasLimit < minGasLimit;
        ...
        while (1) {
          switch (_context13.prev = _context13.next) {
            case 0:
              ...
              newPremiumBn = new _bignumber.BigNumber(message.GasPremium).times(1.25).plus(Number.EPSILON).integerValue(_bignumber.BigNumber.ROUND_CEIL);
              newFeeCap = newPremiumBn.isGreaterThan(message.GasFeeCap) ? newPremiumBn.toString() : message.GasFeeCap;
  ...
  this.jsonRpcEngine = new _filecoinRpcClient["default"](config);
};
