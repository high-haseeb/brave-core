...
export var Filecoin = function Filecoin(provider) {
  ...
  _defineProperty(this, "sendMessage", /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(signedLotusMessage) {
        ...
        while (1) {
          switch (_context13.prev = _context13.next) {
            case 0:
              ...
              newPremiumBn = new BigNumber(message.GasPremium).times(1.25).plus(Number.EPSILON).integerValue(BigNumber.ROUND_CEIL);
