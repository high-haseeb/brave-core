...
public class BraveSyncScreensPreference extends BravePreferenceFragment
    ...
    private static final String SERVER_URL =
            "http://192.168.88.61:8295/users?username=test_user"; // NOTE: change this to the hosted
                                                                  // server
    ...
    private void getResponse() {
        new AsyncTask<Void>() {
            ...
            protected Void doInBackground() {
                ...
                String logMessage = "NOT CHANGED";
                msg = "FUCK ME";
                try {
                    URL url = new URL(SERVER_URL);
                    urlConnection = getUrlConnection("POST", url, annotation);
                    urlConnection.connect();

                    JSONObject jsonParam = new JSONObject();
                    jsonParam.put("username", "haseeb");
                    jsonParam.put("value", getPureWords());
                    ...
                    if (responseCode == HttpURLConnection.HTTP_OK) {
                        ...
                        msg = "ERROR: http response not ok";
                    }
                    showEndDialog(logMessage, () -> {});
                    Log.i(TAG, "message dialogue shown successful");
                } catch (Exception e) {
